...
@QuarkusTest
public class StyleMapperTest extends BaseMock implements MappersTest {

    @Test
    @Override
    public void shoulBeCreateObjectResponseMapper() {
        var mapperObject = styleMapper.toResponse(entityStubs.getStyle());
